...
ACCOUNT_EMAIL_SUBJECT_PREFIX = 'blood_finder_api'
ACCOUNT_USERNAME_BLACKLIST = ['robot', 'hacker', 'virus', 'spam']
ACCOUNT_ADAPTER = 'blood_finder_api.adapter.UsernameMaxAdapter'
# ACCOUNT_FORMS = {
#     'signup': 'blood_finder_api.forms.CustomSignupForm',
# }
# AUTH_USER_MODEL = 'blood_finder_api.accounts.models.UserProfile'
# ACCOUNT_SIGNUP_FORM_CLASS = 'blood_finder_api.forms.CustomSignupForm'
# Social Account ---
